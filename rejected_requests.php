...
$requestSql = "SELECT * FROM Request WHERE status = 'rejected'";
...
<head>
    <meta charset="UTF-8" />
    <title>Rejected Requests | Laundry Service</title>
    ...
    <script>
        function handleAction(requestID, action) {
            ...
            form.method = "post";
            form.action = "rejected_requests.php";
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="delete-btn" onclick="handleAction(<?php echo $request['requestID']; ?>, 'delete')">Delete</button>
                                    </td>
                                </tr>
                            <?php
                            }
